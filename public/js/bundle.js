...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, " system-alert\" role=\"alert\">").concat(msg, "</div>");
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"report.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteItem = exports.report = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Item posted successfully');
              window.setTimeout(function () {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _axios.default.delete("/api/v1/items/".concat(data)).then(function () {
              (0, _alerts.showAlert)('success', 'Item deleted');
              window.setTimeout(function () {
                location.assign("/my-items");
              }, 1500);
            }).catch(function (err) {
              console.log(err.response);
              (0, _alerts.showAlert)('danger', 'Error in deleting na item! Please try again.');
            });
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"filter.js":[function(require,module,exports) {
"use strict";
...
var filter = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(category, city, province, itemType) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/items?category=".concat(category, "&city=").concat(city, "&province=").concat(province)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                location.assign("/view/".concat(itemType, "/search?category=").concat(category, "&city=").concat(city, "&province=").concat(province));
              }, 1500);
            }
  ...
  return function filter(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var userDataForm = document.querySelector('.form--update-setting');
var userPasswordForm = document.querySelector('.form--user-password');
var reportForm = document.querySelector('.form--report-item');
var filterForm = document.querySelector('.form--filter');
var deleteItemBtn = document.querySelector('#deleteItem');
...
if (reportForm) reportForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var form, images3, images2, images1;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            images3 = document.getElementById('images3').files[0];
            images2 = document.getElementById('images2').files[0];
            images1 = document.getElementById('images1').files[0];
            form.append('images', images3);
            form.append('images', images2);
            form.append('images', images1);
            (0, _report.report)(form);
...
if (deleteItemBtn) deleteItemBtn.addEventListener('click', /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            item = document.getElementById('deleteItem');
            itemId = item.getAttribute('data-item-id');
            console.log(itemId);
            (0, _report.deleteItem)(itemId);
...
if (filterForm) filterForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var category, city, province, itemType;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            city = document.getElementById('locationCityInput').value;
            province = document.getElementById('locationProvinceInput').value;
            itemType = document.getElementById('itemType').value;
            (0, _filter.filter)(category, city, province, itemType);
